...
//intress = (this.marginaal + this.euribor).toFixed(2);
arvutaKuumakse(){
  return ((this.ostuhind - this.sissemakse) / this.periood / 12 * (this.marginaal + this.euribor) / 2.7).toFixed (2) 
}
arvutaKorgendatudKuumakse(){
  
  return ((this.ostuhind - this.sissemakse) / this.periood / 12 * (this.marginaal + this.euribor)* 7 / 2.7).toFixed (2) 
}
}
